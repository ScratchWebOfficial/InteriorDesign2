...
import "./use.css";
import { FiShield, FiCalendar, FiAward, FiTool } from "react-icons/fi";

export default function TermsOfUse() {
  return (
    <div className="terms-container">
      <h1 className="title">TERMS OF USE</h1><br/>

      <section>
        <h2>General</h2>
        <p>a. The Terms of Use contained herein along with the Privacy Policy form an Agreement regulating our relationship with regard to the use of HomeLane services by you, the user (hereinafter referred to a "you", "your", "user"), of the www.homelane.com ('Website') and HomeLane mobile application ('App') and such other electronic device from which a user can access the Website or App, including any sub-domains of the Website, or top-level domains including www.homelane.com, mobile sites, Apps and widgets (hereinafter referred to as "Platform").</p><br/>
        <p>b. You are advised to read this Terms carefully. If you are not agreeable to any terms or Privacy Policy, you should not proceed to use this Platform and underlined services. You can use HomeLane services if you are agreeable to all the Terms of Use of this document in their entirety. If you accept this Terms of Use, it will be a legally binding agreement between you and HomeLane.</p><br/>
        <p>c. The User is any person/individual, who visits, uses, browses, or otherwise becomes a buyer on the Platform and avails any Service through the Platform or deals with or transacts with the Platform in any manner.</p><br/>
        ...
        <p>e. We reserve the right to change any of the terms under this Terms of Use for using our Platforms at any time by publishing new "Terms of Use" on the Platform. Your use of our Platform constitutes your acceptance of those Terms of Use. If you are not agreeable to any of our terms of use or other notices on our Platform, your sole option is to immediately cease your use of our Platform and availing our Services.</p><br/>
      </section>

      <section>
        <h2>Eligibility</h2>
        <p>a. Use of the Platform is available only to persons who can form legally binding contracts under applicable law. Persons who are "incompetent to contract" within the meaning of the Indian Contract Act, 1872 including un-discharged insolvents etc. are not eligible to use the Platform. If you are a minor i.e. under the age of 18 years but at least 13 years of age you may use this Platform only under the supervision of a parent or legal guardian who agrees to be bound by these Terms of Use.</p><br/>
        <p>b. HomeLane reserves the right to terminate your use and refuse to provide you with access to the Platform if HomeLane discovers that you are under the age of 18 years. The Platform is not available to persons whose membership has been suspended or terminated by HomeLane for any reason whatsoever.</p><br/>
        <p>c. If you are registering as a business entity, you represent that you have the authority to bind the entity to these Terms. Unless otherwise specified, the products/services on this Platform are directed solely at those who use/avail the products/services within India. HomeLane makes no representation that any products or services referred to in the materials on this Platform are appropriate for use, or available outside India. Those who choose to access this Platform from outside India are responsible for compliance with local/international laws if and to the extent local laws are applicable. HomeLane will deliver the products only within India and will not be liable for any claims relating to any products ordered from outside India.</p><br/>
        <p>d. If you use the Platform, you shall be solely responsible for maintaining the confidentiality of your User Name and Password and you shall be responsible for all activities that occur under your User Name and Password. You agree that if you provide any information that is untrue, inaccurate, not current or incomplete, we shall have the right to indefinitely suspend or terminate or block access to the Platform and/or underlined Services. You agree to immediately notify us of any unauthorized use/ breach of your password or account and ensure that you protect your User Account.</p><br/>
        <p>e. Your mobile phone number and/or e-mail address is treated as your primary identifier on the Platform. It is your responsibility to ensure that your mobile phone number and your email address is up to date on the Platform at all times. You agree to notify us promptly if your mobile phone number or e-mail address changes by updating the same on the Platform through a one-time password verification. You agree that HomeLane shall not be liable or responsible for the activities or consequences of use or misuse of any information that occurs under your Account in cases, including, where you have failed to update your revised mobile phone number and/or e-mail address on the Platform.</p><br/>
      </section>
      ...
      <section>
       ...
       <section className="highlight-section">
            ...
            <div className="feature-box">
            <FiTool size={40} />
            <h3>Post-installation service</h3>
